...
//        }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup view = (ViewGroup) inflater.inflate(R.layout.fragment_culture, container, false);
        videoView = view.findViewById(R.id.video_view);
        String videoPath = "android.resource://" + getActivity().getPackageName() + "/" + R.raw.vid_culture_village;
